...
<header>
    <?php get_template_part('ogp') ?>
        <div class="inner">
            <h1><a href="https://kentalog.work/blog/"><img src="<?php echo esc_url(get_theme_file_uri('./images/fultitlen2.png')); ?>"></a></h1>
            <img class="headgazou" src="<?php echo esc_url(get_theme_file_uri('./images/macaronienpitutracerogonasisvg.png')); ?>">
        </div>
    </header>